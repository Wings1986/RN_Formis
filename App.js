...
export default function App() {
  ...
  const jsCode = `window.onload = function() {Formio.createForm(document.getElementById('formio'), 'https://mocki.io/v1/ea6dd1c9-592a-4282-ac90-e62bca7547a7' ).then(function(form) {
